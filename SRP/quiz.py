...
class Quiz:
	...
	def display_question(self):
		...
		q_no = Label(gui, text=question[self.q_no], width=120,
	...
	def display_title(self):
		...
		title = Label(gui, text="TECHNICAL QUIZ",
		width=90, bg="purple",fg="white", font=("ariel", 20, "bold"))
